...
declare type ModuleNotificationType =
  | "ALL_MODULES_STARTED"
  | "DOM_OBJECTS_CREATED"
  | "MODULE_DOM_CREATED"
  | string;
declare type NotificationPayload = any;
declare type NotifcationSender = any;
declare type ModuleConfiguration = { [key: string]: any };
...
declare type SocketNotifcationEvent = ISocketNotificationEvent<
  NotificationType,
  NotificationPayload
>;
...
declare type ModuleNotificationEvent = IModuleNotificationEvent<
...
declare interface IModuleProperties {
   ...
   * @param {ModuleNotificationType} notification - The notification to be sent
   * @param {object} payload  - The notification payload
   * @param {object} sender   - The message sender
   */
  notificationReceived?: ModuleNotificationEvent;
  /** Event fired on receipt of a socket notification
   * @param {NotificationType} notification - The notification to be sent
   * @param {object} payload  - The notification payload
   */
