...
declare module "node_helper" {
  ...
  export interface IHelperConfig {
     ...
     */
    socketNotificationReceived<T>(
      notification: NotificationType,
      payload: T
    ): void;
    socketNotificationReceived<T extends NotificationPayload>(
      notification: NotificationType,
      payload: T
    ): void;
     ...
     * @param {T} payload The notification payload
     */
    sendSocketNotification?<T>(
      notification: NotificationType,
      payload: T
    ): void;
    sendSocketNotification?<T extends NotificationPayload>(
      notification: NotificationType,
      payload: T
    ): void;
