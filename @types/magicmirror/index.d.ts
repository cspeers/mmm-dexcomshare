...
declare type ModuleNotificationType='ALL_MODULES_STARTED'|'DOM_OBJECTS_CREATED'|'MODULE_DOM_CREATED'|string;
...
declare type ModuleNotificationEvent = IModuleNotificationEvent<ModuleNotificationType,NotificationPayload,NotifcationSender>;
